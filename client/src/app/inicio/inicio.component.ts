...
import { NewsListComponent } from "../elementos/news-list/news-list.component";
...
@Component({
  selector: 'app-inicio',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule, HeroComponent, EventosComponent, NewsListComponent],
